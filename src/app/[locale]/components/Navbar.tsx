                        ...
                        <div className="flex justify-between h-16">
                            <div className="flex justify-between w-full">
                                ...
                                <div className="hidden sm:ml-6 sm:flex sm:space-x-8 sm:items-center">
                                    ...
                                    <ThemeBtn />
                                    <Link href={path == "/es/projects" ? "/en/projects" : path == "/en/projects" ? "/en/projects" : "/en"} locale="en"
                                        className={`${
                                            path.startsWith("/en") ? "border-teal-500 dark:text-white" : "border-transparent text-gray-500 dark:text-gray-300 dark:hover:text-white"
                                          } h-full inline-flex items-center px-1 pt-1 border-b-2 text-sm font-medium`}
                                    >
                                        EN
                                    </Link>
                                    <Link href={path == "/en/projects" ? "/es/projects" : path == "/es/projects" ? "/es/projects" : "/es"} locale="es"
                                        className={`${
                                            path.startsWith("/es") ? "border-teal-500 dark:text-white" : "border-transparent text-gray-500 dark:text-gray-300 dark:hover:text-white"
                                          } h-full inline-flex items-center px-1 pt-1 border-b-2 text-sm font-medium`}
                                    >
                                        ES
                                    </Link>
                            ...
                            <div className="-mr-2 gap-2 flex items-center sm:hidden">
                                <ThemeBtn/>
